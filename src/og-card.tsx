...
// Geist Medium, logo + wordmark top-left. Rendered once per page at build
// time by scripts/og-images.tsx; the /docs/api/og route renders it live for
// previewing design changes in `pnpm dev`.
const W = 1200
const H = 630
const PAD = 80
const BG = '#131316'
...
export function OgCard({ title, path }: { title: string; path: string }) {
