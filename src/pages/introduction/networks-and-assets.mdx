...
Tokens can still be bridged and sent to an external address on Solana and any EVM [Relay network](https://docs.relay.link/references/api/api_resources/supported-chains); see [Swaps](/transactions/swaps). *Settings > Networks* shows assets detected on listed networks you haven't enabled; enable the network to see and use them.
