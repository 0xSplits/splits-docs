...
All partially supported networks support balances, sending, swaps, and bridging.
Accounting history is not yet available on any of them. NFT support varies by
network:

| Network | Balances | Send | Swaps | Bridging | Accounting history | NFTs |
| --- | :---: | :---: | :---: | :---: | :---: | :---: |
| Linea | ✓ | ✓ | ✓ | ✓ | — | — |
| Zora | ✓ | ✓ | ✓ | ✓ | — | ✓ |
| Monad | ✓ | ✓ | ✓ | ✓ | — | — |
...
Robinhood Chain is behind a feature flag and visible only to teams where the
flag is enabled.
