...
Create a key in [Settings > API Keys](https://app.splits.org/settings/team/api-keys/) with the scopes you need (the full matrix is in [Permissions](/teams/permissions#api-key-scopes)):
