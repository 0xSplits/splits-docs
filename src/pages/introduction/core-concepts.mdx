...
When deciding between a new team and an existing one, ask "who are the owners?" Same owners → existing team; different owners → new team. This matters for Recovery. See [Change recovery signers](/accounts/recovery#changing-recovery-signers).
