---
title: Our ops stack
description: The financial tools the Splits team uses to run its business, from banking and accounting to cards and payroll.
---

# Our ops stack [The financial tools we use to run our business]
...
- [Splits](https://app.splits.org/) - we keep about \~20% of our company's assets onchain, about half of which is [earning interest](/accounts/earn) at rates higher than what we would get offchain. All of our onchain assets are stored here, spread out across multiple different dedicated accounts. See [Our workspace setup](/resources/workspace-setup) for more details. A few thoughts:
