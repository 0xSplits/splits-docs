...
An invoice requests one amount of one token into a team account. Invoices do not have line items. The payer can pay in crypto or, if enabled, [by bank transfer](#pay-by-bank).

Invoicing is free. There is no fee for issuing an invoice or making a crypto payment. Only [Owners](/teams/roles) create and manage invoices. Any member can view them.
