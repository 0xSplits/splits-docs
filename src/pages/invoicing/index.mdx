...
Pay-by-bank lets the invoicee pay in fiat from their bank account. It requires the team to set up [a virtual account in the matching currency](/banking) and request the token:
