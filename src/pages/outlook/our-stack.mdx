...
- [Splits](https://app.splits.org/) - we keep about \~20% of our company's assets onchain, about half of which is [earning interest](/accounts/earn) at rates higher than what we would get offchain. All of our onchain assets are stored here, spread out across multiple different dedicated accounts. See [How we secure our assets](/outlook/how-we-secure-our-assets) for more details. A few thoughts:
