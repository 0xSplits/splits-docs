...
# Contacts [Name the addresses your team transacts with]
...
Two restrictions: contacts must be EVM addresses, and your own Splits accounts can't be added as contacts (they're already named).

## How addresses get named

When Splits displays an address, it uses the first name it finds: your own account and bank-account names, then contact labels, then live ENS and Farcaster lookups, then [payee](/contacts/compliance) details, and finally the shortened address. Saving a contact pins a name your whole team sees, instead of depending on what an address resolves to.
