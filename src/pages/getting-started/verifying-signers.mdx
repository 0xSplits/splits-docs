...
- **Disconnecting a connected wallet:** if you're having trouble disconnecting your wallet, first try navigating to a new page (e.g. do to your Dashboard and then return to Settings \> Recovery). If that doesn't work, use your wallet extension to manually disconnect from teams.splits.org. We'll be shipping a fix for this soon.
