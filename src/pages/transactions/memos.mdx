...
Add a memo when you create a transaction. You can also add one later from the transaction row menu (*Add memo*) in any feed. This option also applies to inbound transactions, where later memos are most useful. Any member can add or edit memos.
