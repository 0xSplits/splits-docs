...
Who can propose is governed by [roles](/workspaces/roles): Owners can propose from any account, Members only from accounts they're a signer on.
...
Every transaction can carry a [memo](/transactions/memos), and a workspace can require them on all transactions via the *Require memos* [setting](/workspaces/settings).

## Gas sponsorship

Splits sponsors transaction fees with a monthly gas stipend, applied at the workspace level and shared across all accounts and networks. The stipend is based on the workspace's [Earn](/accounts/earn) balance:
