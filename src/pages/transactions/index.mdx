...
Splits sponsors transaction fees with a monthly gas stipend, applied at the team level and shared across all your accounts and networks. The stipend is based on the team's [Earn](/accounts/earn) balance:
...
Once the stipend is used, transactions are paid in the network's native token (e.g. ETH); the app tells you at submission if the account doesn't hold enough. There is no way to view your remaining stipend yet. Sponsorship policies can change at any time without notice.
