...
A private transfer hides the connection between your account and the recipient: the payout can't be traced back to your account onchain, though your team still sees the recipient and amount in the Splits UI. See the table for supported tokens. Private transfers are behind a feature flag; contact [support@splits.org](mailto:support@splits.org) for access.
