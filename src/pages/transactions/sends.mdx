...
A private transfer hides the connection between your account and the recipient: the payout can't be traced back to your account onchain, though your workspace still sees the recipient and amount in the Splits UI. Private transfers route through [NEAR Confidential Intents](https://intents.near.org/confidential). See the table for supported tokens.
