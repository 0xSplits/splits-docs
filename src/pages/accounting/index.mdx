---
title: Accounting
description: Review transactions, token balances, tax lots, imported account history, and generated reports across a workspace.
---

# Accounting [Review activity, balances, tax lots, and reports across a workspace]

The *Accounting* page combines transactions, token balances, tax lots, imported account history, and generated reports across the workspace's accounts. To annotate transactions for the books, use [memos](/transactions/memos).
...
For disposals, Splits matches tokens to the oldest available lots first (FIFO). Each disposal records its proceeds, basis, gain or loss, and holding period.
