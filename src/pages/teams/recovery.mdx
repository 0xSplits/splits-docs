...
Every account address in the team is [anchored to the recovery configuration](/accounts/security#addresses). The consequence: **changing recovery signers changes the team's account addresses.**
