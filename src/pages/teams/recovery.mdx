---
title: Recovery
description: Why recovery exists, how recovery signers control the Root account, how to recover a team's accounts, and why changing recovery signers changes addresses.
---
...
Recovery is the last resort: first confirm the passkeys are lost. [Verify your own](/accounts/signers#verifying-signers) at [Settings > Personal > Passkeys](https://app.splits.org/settings/personal/passkeys/), and check teammates' passkeys by hovering over the key icon on their row in [Settings > Members](https://app.splits.org/settings/team/members/).

1. Go to [Settings > Recovery](https://app.splits.org/settings/team/recovery/) and select the account marked with a star (★) in the left nav: the owner of all sub-accounts, usually the Treasury.
