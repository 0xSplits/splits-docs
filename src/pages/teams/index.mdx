...
Creating a team takes less than a minute. You can change all settings after setup **except Recovery**. Changing recovery signers later generates new account addresses. See [Change recovery signers](/teams/recovery#changing-recovery-signers).

A member can create and belong to any number of teams. If you just registered, you are guided through creating one. Otherwise click your team's name in the top left and select *Create a team*.
...
- The **Treasury** is owned by the Root and controlled by the owners' passkeys. It is intended to hold most of your assets. It owns every account you create later.
