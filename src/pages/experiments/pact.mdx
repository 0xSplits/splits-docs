...
- [llms.txt](https://pact.splits.org/llms.txt): index of the integration guide, architecture, and contract specification.
- [.well-known/pact.json](https://pact.splits.org/.well-known/pact.json): chain id, contract addresses, and deploy block.
