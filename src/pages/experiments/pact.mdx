...
For the thinking behind PACT, see [this thread](https://x.com/abram/status/2084689867942908347).
...
- PACT is open source. The contracts, app, and docs live in the [0xSplits/pact](https://github.com/0xSplits/pact) repo. For exact pricing, allocation, and lifecycle rules, see the [architecture](https://github.com/0xSplits/pact/blob/main/docs/architecture.md) and [contract specification](https://github.com/0xSplits/pact/blob/main/contracts/docs/contracts.md) there.
