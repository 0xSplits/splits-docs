---
title: Incorporating and banking in the US
description: Options for forming a US legal entity and setting up banking, including Clerky, Stripe Atlas, OtoCo, and Mercury.
---

# Incorporating and banking in the US

*Last updated 6 November 2025*

You're able to use the product without a legal entity (i.e. EIN or SSN), however, some features (like [on/offramping](/getting-started/on-offramping)) aren't available until you have one. There are many ways to create US legal entities, and this guide highlights just a few we are aware of. Not legal advice, do your own research.
...
[OtoCo](https://otoco.io/) lets you create a legal entity using an Etherum account. You can use your Splits accounts to do this (more info on [connecting to third party apps](/getting-started/connecting-to-other-apps)). You choose the jurisdiction and entity type, and OtoCo handles the paperwork filing for you. Once you create your entity, you will be able to request a tax ID.
