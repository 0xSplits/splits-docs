...
| --- | --- | --- |
| Key | A dedicated EOA the CLI generates, [registered as a signer](/accounts/signers#eoas) | The Bankr wallet itself, [enabled as a module](/accounts/modules) |
...
1. An Owner creates an API key in *Settings > API Keys* (**Owner** scope is required for the agent to create accounts or propose signer changes).
