...
- **Lower gas**: Automated Earn bundles up to 10 accounts' deposits into one transaction.

Everything happens natively on Base: no bridges, no wrapped assets. The APY shown in the app is the wrapper's net APY, after the Splits fee.
