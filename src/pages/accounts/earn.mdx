...
Using Earn does not require you to manually account for vault shares or calculate the yield yourself. [Accounting](/accounting) handles the position directly: in the *Tokens* view, it reports the position in underlying USDC, and records net yield under *Change from flow* rather than as a token-price gain.
...
Most accounting platforms also handle Earn vault tokens without special treatment.
