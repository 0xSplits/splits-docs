---
title: Earn
description: "Earn interest on idle capital in your accounts: how deposits and positions work, Automated Earn, the current offering, and the risks."
---

# Earn [Earn interest on idle capital in your accounts]
...
Today Earn supports USDC on Base, deposited into [Aave](https://aave.com/): USDC is the token Splits customers use most, and Aave is the largest lending protocol on Ethereum, with $50B in net deposits. More assets and yield sources are planned; email support@splits.org for specific requests.
...
- **Governance risk**: Aave governance can change parameters affecting your position without notice.
