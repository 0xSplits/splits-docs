...
## Spending from an Earn position

You do not need to withdraw an Earn position before using it. When you [send funds](/transactions/sends), select the Earn position as the source; Splits withdraws the amount needed and sends it to the recipient in the same transaction. Any amount you do not send remains in Earn and continues earning interest.
