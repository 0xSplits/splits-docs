...
The [Accounting page](/accounting) handles Earn positions directly. In the *Tokens* view, it reports the position in underlying USDC rather than vault shares: starting and ending balances reflect its USDC value, and net yield appears under *Change from flow* rather than as a token-price gain.
